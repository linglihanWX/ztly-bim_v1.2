...
<head>
    ...
    <link rel="stylesheet" href="${ctx }/static/page/dungou/fuzhujuece/css/fuzhujuece.css">
</head>
    ...
    <div class="content">
        ...
        <div class="content-right">
            <div class="content-top">
                <p>曲线分析 <input type="date"><span>至</span><input type="date"></p>
                <div id="chart">
...
<script src="${ctx}/static/page/dungou/fuzhujuece/js/fuzhujuece.js"></script>
</body>
