...
<head>
    ...
    <link rel="stylesheet" href="${ctx }/static/page/dungou/riskRoutineIssue/css/riskRoutineIssue.css">
</head>
...
<script src="${ctx}/static/page/dungou/riskRoutineIssue/js/riskRoutineIssue.js"></script>
</body>
