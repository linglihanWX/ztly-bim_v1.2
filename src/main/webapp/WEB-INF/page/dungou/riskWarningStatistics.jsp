...
<head>
    ...
    <link rel="stylesheet" href="${ctx }/static/page/dungou/riskWarningStatistics/css/riskWaringStatistics.css">
</head>
        ...
        <div class="content-right">
            <div class="content-top">
                ...
                <ul>
                    ...
                    <li><span>上报时间:&nbsp;</span><input type="date"><span>&nbsp;至&nbsp;</span><input type="date" name="" id=""></li>
                    <li>
                        <input type="button" name="" id="search" class="btn-active" value="查询">
                        <input type="button" name="" id="reset" value="重置">
                        <input type="button" name="" id="thisWeek" value="本周">
                        <input type="button" name="" id="lastWeek" value="上一周">
                        <input type="button" name="" id="nextWeek" value="下一周">
                    </li>
                </ul>
            </div>
...
<script src="${ctx}/static/page/dungou/riskWarningStatistics/js/riskWaringStatistics.js"></script>
</body>
