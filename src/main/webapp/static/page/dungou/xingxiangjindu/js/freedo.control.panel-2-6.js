...
$(function(){
	...
	var addImg4 = new FDFAction_SpaceImg_AddImg(Img,0,'imgBg4', './img/access/PNG/weiWa.png', 0, 216+288, 1740, 300, 2);
	...
	var addImg37 = new FDFAction_SpaceImg_AddImg(Img,0,'imgBg37', './img/access/PNG/dungou02.png', 1722, 280+288, 17, 58, 2);
	...
	FDPScript.AddAction( addImg7 );  //增加三维地球
	...
	FDPScript.AddAction( changePosition1 ); 
	 ...
	 //debug 图片裁剪  以挖-1
	 /*var clip0 = new FDFAction_SpaceImg_clipImg(Img,0,'imgBg39',1300, 0, 1740, 800);
   ...
   var dynamicClip = setInterval(function(){
	   if(!isNaN(parseInt($("#imgBg37").css("left")))){
		 var  dynamicLeftData = parseInt($("#imgBg37").css("left"))+18;
