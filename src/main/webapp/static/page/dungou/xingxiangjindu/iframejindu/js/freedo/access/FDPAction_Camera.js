...
/**
 *@describe 严轨迹移动需要的数据结构
*/
FDPCameraRoute = function(time, lon, lat, height, course, aipha, roll)
{
	this.m_Time = time;		// 	轨迹点对应的时间  毫秒。
	this.m_Lon = lon;			//	轨迹点对应的经度  度。
	this.m_Lat = lat;			//	轨迹点对应的维度  度。
	this.m_Heigt = height;			//	轨迹点对应的高度  米。
	this.m_Course = course;			//	轨迹点对应的相机方位角	度。
	this.m_Alpha = aipha;			//	轨迹点对应的相机俯仰角	度。
	this.m_Roll = roll;			//	轨迹点对应的相机滚转角	度。	
}
