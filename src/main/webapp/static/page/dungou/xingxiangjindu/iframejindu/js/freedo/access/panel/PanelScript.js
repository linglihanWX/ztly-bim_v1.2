...
/*
	脚本初始化。
	viewer	(in)	平面环境、对应的纯javascript脚本
	返回：无。
*/
FDPScript.Init = function(  )
{
//	var m_Name = name;					//	脚本名称
	...
	/**
	 * @describe 换成javaScript自带定时器
	 * @author fanPeng
	 * @Date 2018年2月3日下午3:21:28
	 */
	setInterval(function(){FDPScript.OnpreRender()},1000);
...
/*
	...
	return	无 
*/
FDPScript.OnpreRender = function(  time )
{
	var date = new Date();
